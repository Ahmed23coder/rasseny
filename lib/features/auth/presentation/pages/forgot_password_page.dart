  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthFailure && state.previousState is ForgotPasswordState) {
      ...
      builder: (context, state) {
        final isLoading = state is AuthLoading && state.previousState is ForgotPasswordState;
        return Scaffold(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  AuthButton(
                                    ...
                                    isLoading: isLoading,
                                    onPressed: isLoading ? null : () => context.read<AuthBloc>().add(
